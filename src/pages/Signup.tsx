...
const Signup = () => {
  ...
  return (
    <div className="flex" style={{ height: 'calc(100vh - 3.5rem)' }}>
      ...
      {/* ── Right panel: form ── */}
      <div className="w-full lg:w-[420px] xl:w-[480px] shrink-0 flex flex-col justify-center px-10 xl:px-16 border-l border-border/20 overflow-y-auto">
        ...
        {/* Header */}
        <div className="mb-10">
          <p className="text-[11px] font-semibold tracking-[0.25em] uppercase text-primary mb-2">Get started</p>
          <h1 className="font-display text-4xl font-bold tracking-tight">Create account.</h1>
          <p className="text-sm text-muted-foreground mt-2">Host screenings and manage your events.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-1.5">
            <Label htmlFor="displayName" className="text-xs uppercase tracking-wide text-muted-foreground">
        ...
        <p className="text-sm text-muted-foreground mt-8">
          ...
          <Link to="/login" className="text-primary underline underline-offset-4 hover:text-primary/80 transition-colors">
            Sign in
          </Link>
        </p>

        <p className="text-xs text-muted-foreground mt-4 leading-relaxed pb-10">
